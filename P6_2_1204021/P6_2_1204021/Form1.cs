...
namespace P6_2_1204021
{
    public partial class Form1 : Form
    {
        private string url = "server=localhost;userid=root;password=;database=p6_1204021";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string url = "server=localhost;userid=root;password=;database=p6_1204021";
            string myConnectionString = "integrated security=true;datasource=localhost;initial catalog=p6_1204021";
            MySqlConnection conn = new MySqlConnection(url);
